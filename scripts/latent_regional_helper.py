...
def division_output(radio_sel: str, col_num_1: str, col_num_2: str, col_num_3: str, col_num_4: str, col_num_5: str, div_ratio: str, back_ratio: str, chkbox_back: bool) -> Tuple[str, str, str]:
    # ドロップダウンリストをリストにまとめる
    ...
    if len(exist_col_num_list) == 0:
        ...
        if radio_sel == "Latent Couple":
            ...
            try:
                ...
                div_ratio = default_div_ratio
            try:
                back_ratio = float(back_ratio)
            except ValueError:
                back_ratio = default_back_ratio
            # Latent Coupleの処理
